...
@Component({
  ...
  templateUrl: './key-result-areas-form.component.html',
  styleUrls: ['./key-result-areas-form.component.css']
})
export class KeyResultAreasFormComponent implements OnInit {
